...
def create_transformed_url(original_url, transformation_params, caption=None):
    ...
    if caption:
        ...
        text_overlay = f"1-text,ie={encoded_caption},ly-N20, lx-20,fs-100,co-white,bg-000000A0, 1-end"
    ...
    transformed_path = f"tr:{transformation_params}/{path}"
    return urllib.parse.urlunsplit((parsed.scheme, parsed.netloc, f"/{transformed_path}", "", ""))
    ...
    if response.status_code == 200:
        ...
        for post in posts:
            ...
            if post['file_type'] == 'image':
                ...
                # For videos: specify only height to maintain aspect ration + caption overlay
...
if st.session_state.user is None:
    ...
    st.sidebar.markdown("---")
    page = st.sidebar.radio("Navigat:",["Feed","Upload"])
